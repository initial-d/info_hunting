...
<table width="900" height="484" border="0" align="center">
  <tr>
    <th width="670" scope="col">图片名称：<s:property  value="getTitle()"  escape="false"/></th>
  ...
  <tr>
    <td height="156" rowspan="3" align="center" bgcolor=#000000>
	
	
	 <a><img src=<%=url %> height="500" width="400"></a>
	</td>
	<td>  
 ...
 <tr>&nbsp;</tr>
  ...
  <tr>
    <td height="80" bgcolor="#CCCCFF"><a color="#000000"><s:property  value="getTitle()"  escape="false"/>.<s:property value="getKind()"/></a><form   action="download"  method="post" >
