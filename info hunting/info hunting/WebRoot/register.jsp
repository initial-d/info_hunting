...
<body>
    <center>
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
            ...
            <tr height="20">
                <td style="text-indent:10" valign="bottom">
                    <a href="file_Add.action?addType=linkTo" style="color:gray">[发布信息]</a>
                    <a href="log_isLogin.action" style="color:gray">[进入后台]</a>
                    <a href="talk.jsp" style="color:gray">[聊天系统]</a>
                    <a href="preview/previewVideo.jsp" style="color:gray">[预览]</a>
        ...
        <table border="0" width="80%"  cellspacing="0" cellpadding="0" style="margin-top:1" >
            <tr ><td align="center" ><img src="images/61.gif" ></td></tr>
        </table>
