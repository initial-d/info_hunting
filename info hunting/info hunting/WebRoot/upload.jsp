...
<body>
    <center>
        ...
        <table border="0" width="80%"  cellspacing="0" cellpadding="0" style="margin-top:-15" >
            <tr ><td align="center" ><img src="images/61.gif" width="900" height="110"></td></tr>
            <tr><td align="right"><a href="index.jsp" >返回首页</a></td></tr>
        </table>
         <table border="0" cellpadding="0" cellspacing="0" width="688" height="68%">
