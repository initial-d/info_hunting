 ...
 */
public class TupianSearch {
	public long timeOfSearch;
	ArrayList<xmlbean> returnResult=new ArrayList<xmlbean>();
	public  ArrayList<xmlbean> tupiansearch(String key) throws IOException {
	...
	for(int i=0;i<keyword.length;i++){
	 ...
	 Hits hits = null;
try {
	tupianFilter filter = new tupianFilter();
